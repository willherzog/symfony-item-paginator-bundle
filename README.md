...
Each entity (or "item") must have its own paginator class extending from abstract class `WHSymfony\WHItemPaginatorBundle\Paginator\ItemPaginator` with definitions for the required methods, as seen below:
