			...
			->children()
				...
				->arrayNode('display_options')
					...
					->children()
						...
						->end()
						->booleanNode('symbol_based_labels')
							->defaultTrue()
							->info('Whether to use single-character symbols for the labels of the previous/next/first/last actions.')
						->end()
						...
						->booleanNode('show_placeholders')
							->defaultFalse()
							->info('Whether to show placeholers for previous/next/first/last actions when they are not applicable (e.g. previous/first on the first page).')
						->end()
